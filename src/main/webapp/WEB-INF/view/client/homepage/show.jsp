                                    ...
                                    <div class="col-lg-12">
                                        <div class="row g-4">
                                            <div class="col-md-6 col-lg-4 col-xl-3">
                                                <div
                                                    class="rounded position-relative fruite-item d-flex flex-column h-100">
                                                    ...
                                                    <div
                                                        class="p-4 border border-secondary border-top-0 rounded-bottom fruite-content d-flex flex-column justify-content-between flex-grow-1">
                                                        <div>
                                                            <h4>Grapes</h4>
                                            ...
                                            <div class="col-md-6 col-lg-4 col-xl-3">
                                                <div class="rounded position-relative fruite-item">
                                                    <div class="fruite-img">
                                                        <img src="https://cdnv2.tgdd.vn/mwg-static/tgdd/Common/cf/38/cf38a4fa60ce66f487f31d69cb5b9cde.png"
                                                            class="img-fluid w-100 rounded-top" alt="">
                                                    </div>
                                                    <div class="text-white bg-secondary px-3 py-1 rounded position-absolute"
                                                        style="top: 10px; left: 10px;">Fruits</div>
