                                    ...
                                    <div
                                        ...
                                        <div class="d-flex justify-content-center py-4">
                                            <a href="index.html" class="logo d-flex align-items-center w-auto">
                                                <img src="https://e7.pngegg.com/pngimages/684/943/png-clipart-apple-logo-computer-icons-apple-logo-heart-logo.png"
                                                    alt="">
                                                <span class="d-none d-lg-block">MacT&B</span>
                                            </a>
                                        </div>
                                        ...
                                        <div class="card mb-4">
                                            <div class="card-body">
                                                ...
                                                <form:form method="post" action="/register"
                                                    modelAttribute="registerUser" class="row g-3 needs-validation">
